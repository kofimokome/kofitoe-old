...
<div class="board">
    ...
    <form name="game" class="board">
        <div id="gamelet" class="fr"><input id="11" onclick="C_11(cplayer); autoname(0);" name="C11" type="text" class="gamelet1" readonly/></div>
        <div id="gamelet" class="sr"><input id="12" onclick="C_12(cplayer); autoname(1);" name="C12" type="text" class="gamelet1" readonly/></div>
        <div id="gamelet" class="tr"><input id="13" onclick="C_13(cplayer); autoname(2);" name="C13" type="text" class="gamelet1" readonly/></div>
        <div id="gamelet" class="fr"><input id="21" onclick="C_21(cplayer); autoname(3);" name="C21" type="text" class="gamelet1 gamelet2" readonly/></div>
